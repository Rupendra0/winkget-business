...
const toProductSummary = (product) => ({
  ...
  showFreeDelivery: Boolean(product.showFreeDelivery),
  showSecureTransaction: Boolean(product.showSecureTransaction),
  showCashOnDelivery: Boolean(product.showCashOnDelivery),
  show7DaySupport: Boolean(product.show7DaySupport),
