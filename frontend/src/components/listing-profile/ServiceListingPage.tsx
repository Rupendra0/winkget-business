      ...
      <div className="mx-auto w-full space-y-0">
        ...
        {selectedService && (() => {
          ...
          return (
            ...
            >
              <div 
                className="relative w-full md:w-[80vw] md:max-w-6xl overflow-hidden rounded-2xl bg-white shadow-2xl transition-all flex flex-col md:flex-row md:h-[620px] max-h-[90vh] cursor-default"
