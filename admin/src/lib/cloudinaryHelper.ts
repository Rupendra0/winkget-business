...
/**
 * Uploads a file directly to Cloudinary from the admin client side using a signed signature.
 * @param file The file to upload.
 * @param folder The target folder in Cloudinary (e.g. 'winkget_categories', 'winkget_ads').
